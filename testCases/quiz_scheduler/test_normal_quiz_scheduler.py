...
class TestQuizSchedulerNormalQuiz:
    ...
    def test_create_quiz_schedule(self):
        self.scheduler.create_new_schedule_single_quiz(ScheduleTestData.category_name)
    ...
    def test_edit_quiz_schedule(self):
        self.scheduler.edit_quiz_schedule_single_quiz()
        # Define the expected success message
    ...
    def test_delete_quiz_schedule(self):
        self.scheduler.delete_quiz_schedule_single_quiz()
        # Define the expected success message
